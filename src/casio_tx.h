...
* program link transmit protocol utility.
*/
...
typedef enum
{
  ST_WAIT_RDY_TO_RECEIVE,
  ST_WAIT_HDR_RESPONSE,
  ST_WAIT_PRG_DATA_RESPONSE,
  ST_WAIT_ALLPRG_DIRECTORY_RESPONSE,
  ST_WAIT_ALLPRG_DATA_RESPONSE,
  ST_DONE,
  ST_NONE
} State;
